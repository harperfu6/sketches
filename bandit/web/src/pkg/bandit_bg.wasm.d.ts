...
export function epsilongreedy_name(a: number, b: number): void;
export function epsilongreedy_reset(a: number, b: number): void;
export function epsilongreedy_select_arm(a: number): number;
export function epsilongreedy_update(a: number, b: number, c: number): void;
